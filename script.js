...
/* ================================================
   13. HERO CODE CARD — Dart / JSX tab switcher
================================================ */
const codeCardTabs   = document.querySelectorAll('.code-card-tab');
const codeCardPanels = document.querySelectorAll('.code-card-panel');

codeCardTabs.forEach(tab => {
  tab.addEventListener('click', () => {
    const target = tab.dataset.ccTab;

    codeCardTabs.forEach(t => {
      t.classList.remove('active');
      t.setAttribute('aria-selected', 'false');
    });
    tab.classList.add('active');
...
/* ================================================
   14. PROJECTS — stack filter (All / MERN / Flutter)
================================================ */
const projectFilters = document.querySelectorAll('.project-filter');
const projectCards   = document.querySelectorAll('.project-card[data-stack]');
...
projectFilters.forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    projectCards.forEach(card => {
      ...
      const show  = filter === 'all' || stack === filter;
